...
function CoursePurchase() {
    ...
    return (
        <div className="assignment__purchases">
            <h3 className='assignment__purchases__title'>Course Help Purchases</h3>
                            ...
                            <><div className=' purchases' key={index}>
                                ...
                                {i.payment === "Completed" ? <>
                                    <div className='purchase row'>
                                        <div className='col-sm-3 p_item'><p className='dt'>Order Placed :<br />{i.deadline}</p></div>
                                        <div className='col-sm-3 p_item'><p className='dt'>Price:{i.price}</p></div>
                                        <div className='col-sm-3 p_item'><p className='dt'>To:{i.email}</p></div>
                                    ...
                                    <div className='row'>
                                        <div className='col-sm-3 data_cont'><h2 className='dt'>Deadline: {i.deadline}</h2>
                                            <h2 className='dt'>
                                                ...
                                                {i.payment == "Completed" ? <a target="_blank" href={`/Course/${i.image}`} className="btn btn-primary sol">View Question</a> : <p className='text-danger'>Purchase the item first</p>}
                                            </h2>
                                        ...
                                        <div className='col-sm-3 data_cont1'>
                                            ...
                                            <div className="dropdown">
                                                ...
                                                <ul className="dropdown-menu">
                                                    ...
                                                    <li><a href="#">subject:{i.title}</a></li>
                                                    <li><a href="#">type:{i.type}</a></li>
                                                    <li className="divider"></li>
                                                    <li><a href="#">Date{i.deadline}</a></li>
                                                </ul>
                                            </div>
                                        </div>
